...
async function starts() {
	...
	dark.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `ala saio pq N serviu na França @${num.split('@')[0]} volta mais N resto de aborto 😂👋`
				let buffer = awat getbufferer(ppimg)
				dark.sendMess(mdata.id, buffer, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	dark.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5519999516507@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5519999516507@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5519999516507@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5519999516507@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5519999516507@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
